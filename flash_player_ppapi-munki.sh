...
munkiimport "$TMPMOUNT2"/"Adobe Flash Player-PPAPI.pkg" --name="Adobe Flash Player PPAPI" --displayname="Adobe Flash Player PPAPI" --developer="Adobe" --description="Adobe Flash Player PPAPI" --pkgvers="${flash_version}" --unattended_install --nointeractive --repo-path="${munkirepo}" -c "${munki_cat}" -c "${munki_cat2}"
